...
class createcourse_form extends moodleform {
    public function definition() {
        ...
        $mform->addElement('text', 'termcode', get_string('idx_termcode_txt', 'tool_createcourse'), 'class="textbox"');
        $mform->setType('termcode', PARAM_NOTAGS);
        $mform->setDefault('termcode', '');
        
        $mform->addElement('text', 'courseid', get_string('idx_courseid_txt', 'tool_createcourse'), 'class="textbox"');
        $mform->setType('courseid', PARAM_NOTAGS);
        $mform->setDefault('courseid', '');
        
        $mform->addElement('text', 'suffix', get_string('idx_suffix_txt', 'tool_createcourse'), 'class="textbox"');
